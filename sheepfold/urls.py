...
urlpatterns = [
    ...
    path("milk-analysis/", views.milk_analysis_view, name="milk_analysis"),
    path('api/milk-analysis/', views.milk_analysis_api, name='milk-analysis-api'),
    path('api/milk-analysis/<int:pk>/', views.milk_analysis_detail_api, name='milk-analysis-detail-api'),
